...
function LoginFormContent() {
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      <div className="glass-card rounded-3xl p-8 border border-white/60 shadow-2xl space-y-6">
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-4 text-xs font-body-sm">
          ...
          <button
            ...
            className="w-full py-3 bg-primary text-on-primary font-label-md font-bold text-xs rounded-full hover:bg-primary-container transition-all shadow-md flex items-center justify-center gap-2 mt-2"
          >
            {isSubmitting ? (
              <>
      ...
      <div className="glass-card rounded-2xl p-5 border border-outline-variant/20 space-y-2 text-xs">
