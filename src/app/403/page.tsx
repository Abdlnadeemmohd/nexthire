  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-mesh flex items-center justify-center p-6 pt-24">
        <div className="glass-card rounded-2xl p-10 max-w-lg w-full text-center space-y-6 border border-white/60 shadow-2xl">
          ...
          <div className="space-y-2">
            ...
            <p className="text-on-surface-variant font-body-md text-sm leading-relaxed max-w-md mx-auto">
          ...
          <div className="pt-4 border-t border-outline-variant/20 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href={portal.link}
              className="w-full sm:w-auto px-6 py-3 bg-primary text-on-primary font-label-md font-bold text-xs rounded-full hover:bg-primary-container transition-all shadow-md"
            >
              Return to {portal.title}
            </Link>
            <Link
              href="/"
              className="w-full sm:w-auto px-6 py-3 bg-surface-container-high text-on-surface font-label-md font-bold text-xs rounded-full hover:bg-surface-container transition-all"
            >
              Back to Home
            </Link>
          </div>
