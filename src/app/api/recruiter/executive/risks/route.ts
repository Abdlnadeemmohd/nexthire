...
import { detectOrganizationalRisks } from "@/lib/executive";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: error.message || "Failed to detect organizational risks" }, { status: 500 });
  }
}
