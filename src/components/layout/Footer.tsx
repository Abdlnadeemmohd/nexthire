...
export function Footer() {
  ...
  return (
    <footer className="bg-surface-container border-t border-outline-variant/20 pt-6 sm:pt-10 pb-6 sm:pb-8 transition-colors duration-200 mt-auto w-full flex-shrink-0">
