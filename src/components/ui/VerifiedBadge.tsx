    ...
    switch (role) {
      case "PLATFORM_ADMIN":
        return {
          ...
          colorClasses:
            "bg-rose-500/15 text-rose-600 border-rose-500/30 dark:bg-rose-950/40 dark:text-rose-400 dark:border-rose-800/50",
      ...
      case "PREMIUM_RECRUITER":
        return {
          ...
          colorClasses:
            "bg-amber-500/15 text-amber-600 border-amber-500/30 dark:bg-amber-950/40 dark:text-amber-400 dark:border-amber-800/50",
      ...
      case "HIRING_PARTNER":
        return {
          ...
          colorClasses:
            "bg-purple-500/15 text-purple-600 border-purple-500/30 dark:bg-purple-950/40 dark:text-purple-400 dark:border-purple-800/50",
      ...
      default:
        return {
          ...
          colorClasses:
            "bg-blue-500/15 text-blue-600 border-blue-500/30 dark:bg-blue-950/40 dark:text-blue-400 dark:border-blue-800/50",
