...
export const SUBSCRIPTION_TIER_STYLES: Record<SubscriptionTier, TierStyleConfig> = {
  FREE: {
    ...
    cardActiveBorder: "border-2 border-blue-500/50 bg-blue-500/10 shadow-sm ring-2 ring-blue-500/20",
    activeButtonBg: "bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-500/30",
    statusPill: "bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-500/30",
  ...
  SILVER: {
    ...
    cardActiveBorder: "border-2 border-slate-400/60 bg-slate-500/10 shadow-sm ring-2 ring-slate-400/20",
    activeButtonBg: "bg-slate-500/10 text-slate-700 dark:text-slate-300 border border-slate-400/40",
    statusPill: "bg-slate-500/10 text-slate-700 dark:text-slate-300 border border-slate-400/40",
  ...
  GOLD: {
    ...
    cardActiveBorder: "border-2 border-amber-500/60 bg-amber-500/10 shadow-sm ring-2 ring-amber-500/20",
    activeButtonBg: "bg-amber-500/10 text-amber-800 dark:text-amber-300 border border-amber-500/40",
    statusPill: "bg-amber-500/10 text-amber-800 dark:text-amber-300 border border-amber-500/40",
  ...
  PLATINUM: {
    ...
    cardActiveBorder: "border-2 border-indigo-500/60 bg-indigo-500/10 shadow-sm ring-2 ring-indigo-500/20",
    activeButtonBg: "bg-indigo-500/10 text-indigo-800 dark:text-indigo-300 border border-indigo-500/40",
    statusPill: "bg-indigo-500/10 text-indigo-800 dark:text-indigo-300 border border-indigo-500/40",
  ...
  DIAMOND: {
    ...
    cardActiveBorder: "border-2 border-cyan-500/60 bg-cyan-500/10 shadow-sm ring-2 ring-cyan-500/20",
    activeButtonBg: "bg-cyan-500/10 text-cyan-800 dark:text-cyan-300 border border-cyan-500/40",
    statusPill: "bg-cyan-500/10 text-cyan-800 dark:text-cyan-300 border border-cyan-500/40",
...
export function normalizeSubscriptionTier(tier?: string | null): SubscriptionTier {
  ...
  if (upper.includes("FREE") || upper.includes("TRIAL")) return "FREE";
  return "FREE";
}
